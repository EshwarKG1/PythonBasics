...
class PlotGraphClass:
  ...
  def plotA_running(self,stopA):
      ...
      plotting_values_yA = []
      while True:
          #print(plotting_values_xA)
          """
          plotting_values_xA = self.aX_plot_values 
          plotting_values_yA = self.aY_plot_values 
        
          """
          plotting_values_xA = myReadValues()[0]
          plotting_values_yA = myReadValues()[1]

          #print(myReadValues()[0]),self.aY_plot_values
           #= myReadValues()
          """
          was_x,was_y = myReadValues()
          #print("X : ",was_x)
          plotting_values_xA.append(was_x)
          #print("Y : ",was_y)
          plotting_values_yA.append(was_y)
          """
          try:
              subPlotHandle = subplot.plot(plotting_values_xA,plotting_values_yA, color='#FF6700')
          except ValueError:
              print("A : ",len(self.aX_plot_values))
              print("B : ",len(self.aY_plot_values))
  ...
  def plotB_running(self,stopB):
      ...
      while True:
          """
          plotting_values_xB = ReadValuesChannelBB()[0]
          #self.bX_plot_values,myReadValuesB()[0]
          #print(myReadValues()[0])
          plotting_values_yB = ReadValuesChannelBB()[1]
          
          
          wasB_x,wasB_y = myReadValuesB()
          plotting_values_xB.append(wasB_x)
          plotting_values_yB.append(wasB_y)
       
          #print(plotting_values_xA)
          plotting_values_xB = myReadValuesB()[0]
          #self.bX_plot_values,myReadValuesB()[0]
          #print(myReadValues()[0])
          plotting_values_yB = myReadValuesB()[1]
          #self.bY_plot_values,myReadValuesB()[1]
          
          
          """
          #plotting_values_xB = self.bX_plot_values
          #plotting_values_yB = self.bY_plot_values
          
          try:
            if self.plotValuesFlag == 0:
              self.plotValuesFlag = 1
              if len(self.bX_plot_values) < len(self.bY_plot_values):
                  print("\n\nXB : ",len(self.bX_plot_values))
                  print("YB : ",len(self.bY_plot_values))
                  print("XB(-2) :", self.bX_plot_values[-2], "YB(-2) :", self.bY_plot_values[-2] )
                  print("XB(-1) :", self.bX_plot_values[-1], "YB(-1) :", self.bY_plot_values[-1] )
              subPlotHandle, = subplot.plot(self.bX_plot_values, self.bY_plot_values, color='#00B5FF')
              self.plotValuesFlag = 0
          except ValueError as e:
              print("\n\n[ERROR]",e)
              print("XB : ",len(self.bX_plot_values))
              print("YB : ",len(self.bY_plot_values))
              print("XB(-2) :", self.bX_plot_values[-2], "YB(-2) :", self.bY_plot_values[-2] )
              print("XB(-1) :", self.bX_plot_values[-1], "YB(-1) :", self.bY_plot_values[-1] )
              #subPlotHandle, = subplot.plot(self.bX_plot_values, self.bY_plot_values, color='#00B5FF')
