  ...
  def plotB(self):
      ...
      while True:
          try:
              ...
              #subPlotHandle.set_data(self.bX_plot_values, self.bY_plot_values)
          except ValueError:
              print(len(self.bX_plot_values))
              print(len(self.bY_plot_values))
              #subPlotHandle, = subplot.plot(self.bX_plot_values, self.bY_plot_values, color='#00B5FF')
              exit()
          #subPlotHandle.set_ydata(self.bY_plot_values)
          #subPlotHandle.set_xdata(self.bX_plot_values)
          canvas.draw()
          canvas.flush_events()
      return
