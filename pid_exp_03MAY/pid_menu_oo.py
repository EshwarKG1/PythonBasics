...
def GraphADetectorA():
    global values_thread_A
    global A_Flag,startAcquire,yA_values_forSavefile,xA_values_forSavefile,acquireButton,stopButton
    xA_values_forSavefile = []
    yA_values_forSavefile = []
...
def GraphBDetectorB():
    ...
    global B_Flag,startAcquire,yB_values_forSavefile,xB_values_forSavefile,acquireButton,stopButton
    xB_values_forSavefile = []
    yB_values_forSavefile = []
    #acquireIcon_state = DISABLED
    startAcquire = True
