...
def matplot_basic():
    ...
    fig = Figure(figsize = (12,6.5),dpi = 100)#, facecolor = 'grey')
    ...
    fig.tight_layout()
    canavas = FigureCanvasTkAgg(fig,master=new)
    canavas.draw()
    canavas.get_tk_widget().pack(side = TOP)
...
def matplot_basic1():
    ...
    fig1 = Figure(figsize = (10,6.5),dpi = 100)#,facecolor = 'violet')
    ...
    canavas1 = FigureCanvasTkAgg(fig1,master=new1)
    canavas1.draw()
    canavas1.get_tk_widget().pack(side = TOP)
...
def matplot_basic2():
    ...
    fig2 = Figure(figsize = (10,6.5),dpi = 100)#,facecolor = 'grey')
    ...
    fig2.tight_layout()
    canavas2 = FigureCanvasTkAgg(fig2,master=new2)
    canavas2.draw()
    canavas2.get_tk_widget().pack(side = TOP)

# button to perform the respective works
btn1 = Button(top,text='Display the JS plotting',command=matplot_basic,height = 1,width = 30,font = ('calibri',15,'bold'), fg = 'white', bg = 'grey').place(x = 140, y = 90)

btn2 = Button(top,text='Display the RPM Split plotting',command=matplot_basic1,height = 1,width = 30,font = ('calibri',15,'bold'), fg = 'white', bg = 'grey').place(x = 140, y = 160)

btn3 = Button(top,text='Display the JS-Y vs RPM plotting',command=matplot_basic2,height = 1,width = 30,font = ('calibri',15,'bold'), fg = 'white', bg = 'grey').place(x = 140, y = 230)
