...
class PlotGraphClass:
  def __init__(self, parentwindow):
        ...
        self.listOfPointsA = [0.01,0.02,0.03,0.05,0.06,0.03,0.03,0.04,0.04,0.02,0.01,0.01,0,0.01,0.02,0.02,0.02,0.02,0.03,0.03,0.09,0.5,0.09,0.06,0.05,0.02,0.01]
  ...
  def plotA(self,option):
      ...
      subPlotHandle =subplot.plot(X,Y, color='#FF6700')  # Actual plot    
